    ...
    await Promise
        ...
        .then(async (value)=>{
            ...
            for(let i=0 ; i<msgList.length ; i++) {
                if(latestAlarmID != "" && msgList[i].alarmId == latestAlarmID){
                    break;
                }
                ...
                await download(msgList[i].alarmPicUrl, '../../assets/img', {filename: filename});
...
exports.setInterval = setInterval(getYingshiMsg, 10000);  //每一分钟执行一次