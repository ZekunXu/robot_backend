...
async function intervalFunc(appKey) {
...
async function updateWebCamStatus() {
    ...
    let sessionList = [
        "04558814829445b59c66c281da6e9730",
        "2dc504a81688468691d38e81dbefad56"
    ];

    for(let i=0 ; i<sessionList.length ; i++) {
        await intervalFunc(sessionList[i]);
    }

}

exports.setInterval = setInterval(updateWebCamStatus, 12000);